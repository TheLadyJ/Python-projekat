from pytube import YouTube  # Korišćenje pytube biblioteke
from moviepy.editor import *  # Korišćenje moviepy biblioteke
import os # Korišćenje os modula za brisanje fajlova.
import shutil  # Korišćenje os modula za brisanje fajlova
  ...
  # transcript - Promenljiva u kojoj će se staviti tekst dobijen sa YouTube snimka
    ...
    if request.method == "POST":
        ...
        if url:
            ...
            try:
                # Koristi se importovan objekat YouTube (iz biblioteke pytube) kako bi se skinuo video YouTube linka koji je korisnik uneo
